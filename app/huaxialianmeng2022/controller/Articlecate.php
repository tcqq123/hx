		...
		if($id > 0) {
    		...
    		if($this->request->isPost()) {
	            ...
	            if(false == $model->allowField(true)->save($post,['id'=>$id])) {
	            	...
	            	return $this->success('修改分类成功','huaxialianmeng2022/articlecate/index');
	            }
    		} else {
    			//非提交操作
    			$cate = $model->where('id',$id)->find();
    		...
    		if($this->request->isPost()) {
	            ...
	            if(false == $model->allowField(true)->save($post)) {
	            	...
	            	return $this->success('添加成功','huaxialianmeng2022/articlecate/index');
	            }
    		} else {
    			//非提交操作
    	...
    	if($this->request->isAjax()) {
            ...
            if(Db::name('article_cate')->where('pid',$id)->select() == null) {
                if(false == Db::name('article_cate')->where('id',$id)->delete()) {
                    ...
                    addlog($id);//写入日志
                    return $this->success('删除成功','huaxialianmeng2022/articlecate/index');
                }
            } else {
