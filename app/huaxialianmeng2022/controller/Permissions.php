    ...
    protected function _initialize()
    {
        ...
        if(!empty($black_ip)) {
            ...
            if(in_array($ip,$black_ip)) {
                ...
                return $this->error('你已被封禁！','huaxialianmeng2022/common/login');
            }
        }
        ...
        if(!Session::has('admin')) {
            ...
            $this->redirect('huaxialianmeng2022/common/login');
        }

        // if(!$this->onlyLoginCheck()){
        //     session('admin',NULL);
        //     return $this->error('您的账号已在其他设备登录!','huaxialianmeng2022/common/login');
        // }
