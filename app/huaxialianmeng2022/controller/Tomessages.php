...
use app\huaxialianmeng2022\model\Messages;
    ...
    public function publish()
    {
		...
		if($this->request->isPost()) {
            ...
            if(false == $model->allowField(true)->save($post)) {
            	...
            	return $this->success('提交成功','huaxialianmeng2022/tomessages/index');
            }
		} else {
			//非提交操作
			return $this->fetch();
    ...
    public function delete()
    {
    	if($this->request->isAjax()) {
            ...
            if(false == Db::name('messages')->where('id',$id)->delete()) {
                ...
                addlog($id);//写入日志
                return $this->success('删除成功','huaxialianmeng2022/tomessages/index');
            }
    	}
    }
}
